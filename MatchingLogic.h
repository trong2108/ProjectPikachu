//A struct to save coordinate of a cell
struct Cell_index
{
    int x;
    int y;

    void moveLeft(Cell** Board);
    void moveUp(Cell** Board);
    void moveRight(Cell** Board);
    void moveDown(Cell** Board);
};

//Check if two cell is I matching based on there coordinate
...
//Check if two cell is L matching based on there coordinate
...
//Check if two cell is Z matching or U matching based on there coordinate
...
//Check if two cell is matching based on there coordinate
...
//Check if a board still have a legitimate move
...
//Find a legitimate move in the board
