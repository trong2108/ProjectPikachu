//A struct to save a player infomation
struct Player
{
    string username;
    int point;
...
//Find if an account is already register. If yes return the highest point to the highestPoint variable
...
//Read the "UserInfo.txt" file and put everything in a 1D pointer array
...
//Rewrite the highest point of an already existed account
...
//Write the highest point of a new account
...
//return the length of a positive interger
int numLen(int n)
{
    if(n <= 0)
        return 1;
